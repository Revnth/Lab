...
class Deque {
    ...
    public void displayQueueForward() {
        first.displayLink();
    ...
    public void displayQueueBackward() {
        last.displayLink();
        Link currentLink = last.prev;
        while(currentLink != null) {
            System.out.print(" <-> ");
            currentLink.displayLink();
        ...
        while (online) {
            ...
            switch (chosen) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.print("The elements of the queue are (forward) : ");
                    queue.displayQueueForward();
                    break;
                case 8:
                    System.out.print("The elements of the queue are (backward) : ");
                    queue.displayQueueBackward();
                    break;
                case 9:
                    online = false;
                    break;
